...
internal sealed class ThreadLocalDisposableTests
{
    ...
    public void Run()
    {
        ...
        Should.Throw<ObjectDisposedException>(() => threadLocal.Value.ShouldBe(someDisposable))
            .Message.ShouldBe($"Cannot access a disposed object.{Environment.NewLine}Object name: 'System.Threading.ThreadLocal`1[[System.IDisposable, System.Private.CoreLib, Version=10.0.0.0, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]'.");
        someDisposable.DidNotReceive().Dispose();
