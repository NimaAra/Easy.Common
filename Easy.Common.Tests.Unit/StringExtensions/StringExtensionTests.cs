...
public sealed class StringExtensionsTests
{
    ...
    {
        input.TryParseAsBool(out bool result).ShouldBeTrue();
        result.ShouldBeTrue();
    }
    ...
    {
        input.TryParseAsBool(out bool result).ShouldBeFalse();
        result.ShouldBeFalse();
    }
    ...
    public void When_parsing_null_string_as_boolean() =>
        ...
        {
            ((string)default!).TryParseAsBool(out bool result).ShouldBeFalse();
            result.ShouldBeFalse();
    ...
    public void When_truncating_strings()
    {
        Should.Throw<ArgumentNullException>(() => ((string)null!).Truncate(1))
            .Message.ShouldBe("Value cannot be null. (Parameter 'source')");
    ...
    {
        Should.Throw<NullReferenceException>(() => ((string)null!).RemoveNewLines())
            .Message.ShouldBe("Object reference not set to an instance of an object.");
    ...
    {
        Should.Throw<NullReferenceException>(() => ((string)null!).IsPalindrome())
            .Message.ShouldBe("Object reference not set to an instance of an object.");
    ...
    public void When_compressing_then_decompressing_string()
    {
        ...
        string compressedContent = Content.Compress();
    ...
    {
        string[] result = "hello body okay foo thERE".SplitAndTrim(' ');
